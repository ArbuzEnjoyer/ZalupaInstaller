...
modpack_zip = os.path.join(sys._MEIPASS, "modpack.zip") if hasattr(sys, "_MEIPASS") else "modpack.zip"
tlauncher_zip = os.path.join(sys._MEIPASS, "AHAHASHECHKI.zip") if hasattr(sys, "_MEIPASS") else "AHAHASHECHKI.zip"
